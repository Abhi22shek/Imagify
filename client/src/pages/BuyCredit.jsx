        ...
        {plans.map((item, index) => (
          <div className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-105 transition-all duration-500' key={index}>
            ...
            <div className='flex flex-col mt-4'>
              <button onClick={() => paymentRazorpay(item.id)} className='w-full bg-black text-white flex justify-center gap-2 border border-gray-400 mt-2 text-sm rounded-md py-2.5 min-w-52  hover:border-blue-400'>
                    Buy
              </button>
            </div>
          </div>
